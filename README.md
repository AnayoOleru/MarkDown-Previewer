...
# MarkDown-Previewer
Day 29: A markdown previewer where you can create your texts with any markdown tags or format, and see the result as soon as you type.

https://anayooleru.github.io/MarkDown-Previewer/
...
- Clone the repository to your computer ensure to run the command below in the directory you want to store the project.
    # git clone https://github.com/AnayoOleru/MarkDown-Previewer.git
```
